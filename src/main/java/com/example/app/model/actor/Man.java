...
public class Man extends Actor
{
    ...
    /**
     * Create a new Man at location in field.
     * 
     * @param field The field currently occupied.
     * @param location The location within the field.
     * @param randomAge Returns true if a random age is to be assigned to an Man
     * @param disease Whether an Man has a disease
     */
    public Man(Field field, Location location, boolean randomAge, boolean disease)
    {
    ...
    /**
     * Make this Man act - that is: make it do
    ...
    {
        //everytime an Man acts (a step simulated),
        ...
        if(isAlive()){
            ...
            //If an Man has not eaten in 24 hours,
